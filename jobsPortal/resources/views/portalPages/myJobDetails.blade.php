...
@section('content')
    @foreach($jobs as $detail)
        ...
        <div style="margin-top: 20px; margin-left: 28px" class="buttons">
            <a style="margin-right: 20px" class="button"  href="/my_posted_jobs/edit/{{$detail->id}}" >Edit</a>
            <a class="button" href="/my_posted_jobs/delete/{{$detail->id}}">Delete</a>
        </div>
    @endforeach
@endsection
